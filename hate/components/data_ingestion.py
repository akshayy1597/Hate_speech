...
from hate.entity.config_entity import DataIngestionConfig   #to access the config entity 
from hate.entity.artifact_entity import DataIngestionArtifacts  #to access the artifact entity 
...
class DataIngestion:
    ...
    def get_data_from_gcloud(self) -> None:     #this method is used to get the data from gcloud bucket 
        try:
    ...
    def unzip_and_clean(self):  #this method is used to unzip the file and clean the data 
